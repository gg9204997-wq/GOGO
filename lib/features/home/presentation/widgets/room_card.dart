...
class RoomCard extends StatelessWidget {
  ...
  const RoomCard({
    required this.roomName, required this.ownerName, required this.coverImage, required this.ownerAvatar, required this.countryFlag, required this.members, super.key,
    this.isLive = true,
    this.isVip = false,
  });
